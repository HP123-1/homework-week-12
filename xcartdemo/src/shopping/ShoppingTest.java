...
public class ShoppingTest extends Utility {
    ...
    public void verifyThatUserShouldPlaceOrderSuccessfullyForCupOfMojoBluetoothSpeaker() throws InterruptedException {
        ...
        // mouseHoverToElement(By.xpath("//a[contains(text(),'Avengers: Fabrikations Plush [Related Products]"));
        // driver.findElement(By.xpath("//button[contains@class,'btn  regular-button add-to-cart product-add2cart productid-16')]//span[contains(text(),'Add to cart')]")).click();

        String expectedMsg = "Product has been added to your cart";
        String actualMsg = getTextElement(By.xpath("//div[@id = 'status-messages']"));
...
//to closepop up
        ...
        clickOnElement(By.xpath("//div[@title='Your cart']"));//your cart
...
//verify subtotal
        ...
        sendTextToElement(By.xpath("//input[@id='shippingaddress-firstname']"), "oscar");
        sendTextToElement(By.xpath("//input[@id='shippingaddress-lastname']"), "pandya");
        sendTextToElement(By.xpath("//input[@id='shippingaddress-street']"), "1-7 street");
        sendTextToElement(By.xpath("//input[@id='shippingaddress-city']"), "watford");
        selectValueFromdropDown(By.xpath("//select[@id='shippingaddress-country-code']"), "FR");
        sendTextToElement(By.xpath("//input[@id='shippingaddress-custom-state']"), "herts");
        sendTextToElement(By.xpath("//input[@id='shippingaddress-zipcode']"), "wd24 4yr");
        sendTextToElement(By.xpath("//input[@id='email']"), "abc123@yahoo.com");
        clickOnElement(By.xpath("//input[@id='create_profile']")); // checkbox
        sendTextToElement(By.xpath("//input[@id='password']"), "morari");
